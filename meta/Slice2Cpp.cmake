...
macro( GENERATE_SLICE2CPP_RULES generated_cpp_list generated_header_list )
    ...
    set( slice_module              ${BACKUP_ROOT_PATH} )
...
#     set( proj_slice_bin_dir        ${PROJECT_BINARY_DIR}/src/interfaces/slice )
    ...
    foreach( slice_source_basename ${ARGN} )
        ...
        #message( STATUS "DEBUG: Dealing with ${slice_source}")
...
#         message( STATUS "DEBUG: Adding rule for generating header file from ${slice_source_basename}" )
        string( REGEX REPLACE "\\.ice" ".proto.h" header_basename "${slice_source_basename}" )
        list( APPEND ${generated_header_list} ${header_basename} )
        string( REGEX REPLACE "\\.ice" ".proto.cc" cpp_basename "${slice_source_basename}" )
        ...
        add_custom_command(
            OUTPUT  ${CMAKE_CURRENT_BINARY_DIR}/${header_basename}
                    ${CMAKE_CURRENT_BINARY_DIR}/${cpp_basename}
            COMMAND ${generator_command}
            ARGS ${slice_args} ${slice_source}
            DEPENDS ${slice_depends} ${generator_command}
            COMMENT "-- Generating source files from ${slice_source}"
            VERBATIM
        )
