...
#     message( STATUS "DEBUG: ICE_HOME_INCLUDE_ICE=" ${ICE_HOME_INCLUDE_ICE} )
      ...
      set( ICE_HOME ${ICE_HOME} CACHE INTERNAL "Ice home" )
      set( ICE_INCLUDE_DIR ${ICE_HOME}/include CACHE INTERNAL "Ice include directory" )
      set( ICE_LIBRARY_DIR ${ICE_HOME}/lib CACHE INTERNAL "Ice library directory" )
...
#     message( STATUS "DEBUG: ICE_SLICE_ICE=" ${ICE_SLICE_ICE} )
      ...
      set( ICEUTIL_HOME ${ICE_HOME} CACHE INTERNAL "IceUtil home directory" )
      set( ICE_SLICE_DIR ${ICE_SLICE_DIR} CACHE INTERNAL "Slice directory" )
...
# don't bother if Ice for C++ was not found
  if( ICE_FOUND )
      ...
      if( ICEJ_HOME )
          ...
          set( ICEJ_HOME ${ICEJ_HOME} CACHE INTERNAL "IceJ home" )
